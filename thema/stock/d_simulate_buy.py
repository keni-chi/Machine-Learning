...
class Buy():
    ...
    def run(self):
        # df_buyを読み込み
        df_buy = pd.read_csv(f'd_simulate_{d_simulate_conf.RUNDATE}/{str(self.code)}/df_buy.csv', index_col=0, encoding='shift-jis')
        ...
        df_start.to_csv(f'd_simulate_{d_simulate_conf.RUNDATE}/{str(self.code)}/df_start.csv', encoding='shift-jis')
