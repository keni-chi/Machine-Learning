...
# コード
data_j  = pd.read_csv('usa_code.csv', usecols=[0, 1], encoding='shift_jis')
print(data_j )
...
# フォルダ作成
SAMPLE_DIR = f'usa-data-yahoo-{usa_simulate_conf.RUNDATE}'
...
def get_stock_data():
    ...
    for code in target_no_list:
        ...
        try:
            ...
            tmp.to_csv(f'./usa-data-yahoo-{usa_simulate_conf.RUNDATE}/stock_'+ str(code) + '.csv', )
        except:
